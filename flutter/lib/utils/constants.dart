...
RegistrationStep registrationStepFromString(String? s) {
  switch (s?.toUpperCase()) {
    case 'PROFILE':  return RegistrationStep.profile;
    case 'INCOME':   return RegistrationStep.income;
    case 'LOCATION': return RegistrationStep.location;
    case 'DONE':     return RegistrationStep.done;
    default:         return RegistrationStep.profile;
  }
}
...
const List<PlanInfo> kPlans = [
  PlanInfo(
    ...
    features: ['₹240 weekly payout cap', 'Rain + AQI triggers', 'UPI instant transfer'],
  ),
  PlanInfo(
    name: 'STANDARD',
    weeklyPremium: 34,
    ...
    features: ['₹480 weekly payout cap', 'All weather triggers', 'UPI instant transfer', 'Priority support'],
  ),
  PlanInfo(
    name: 'PREMIUM',
    weeklyPremium: 59,
    ...
    features: ['₹840 weekly payout cap', 'All triggers + income drop', 'UPI instant transfer', 'Dedicated support', 'KYC fast-track'],
  ),
];
  ...
  return base.copyWith(
    ...
    appBarTheme: AppBarTheme(
      ...
      titleTextStyle: GoogleFonts.spaceGrotesk(
        fontSize: 20, fontWeight: FontWeight.w700, color: AegisColors.textPrimary,
      ),
...
Color riskColor(String level) {
  switch (level.toUpperCase()) {
    case 'LOW':      return AegisColors.riskLow;
    case 'MEDIUM':   return AegisColors.riskMedium;
    case 'HIGH':     return AegisColors.riskHigh;
    case 'CRITICAL': return AegisColors.riskCritical;
...
IconData riskIcon(String level) {
  switch (level.toUpperCase()) {
    case 'LOW':      return Icons.shield_outlined;
